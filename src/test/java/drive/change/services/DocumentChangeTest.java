...
public class DocumentChangeTest {
    private static Logger logger = LoggerFactory.getLogger(DocumentChange.class.getSimpleName());
    ...
    public void testAnnotation(){
        DocumentChange service = Guice.createInjector(new ChangeModule()).getInstance(DocumentChange.class);
