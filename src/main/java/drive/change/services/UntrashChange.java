...
import drive.change.annotations.UnTrash;
 ...
 */
public class UntrashChange implements ChangeInterface {
    private CustomChange structure;
    private ChangeServiceInterface service;
    private ChangeUpdateInterface update;

    @Inject
    public UntrashChange(@UnTrash ChangeServiceInterface service, @UnTrash ChangeUpdateInterface update){
